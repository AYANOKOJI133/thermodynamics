...
export const flashcardsData = [
  ...
  { id: 'f16', session: 1, front: "Quelle est l'equation d'etat du gaz parfait?", back: "$PV = nRT$, avec $R = 8.314 \\, \\text{J.K}^{-1}\\text{.mol}^{-1}$" },
  ...
  { id: 'f34', session: 1, front: "Quelle est la condition de Schwartz?", back: "$\\frac{\\partial^2 f}{\\partial x \\partial y} = \\frac{\\partial^2 f}{\\partial y \\partial x}$ (egalite des derivees secondes croisees)." },
  ...
  { id: 'f40', session: 1, front: "Qu'est-ce que le coefficient alpha?", back: "Coefficient de dilatation isobare: $\\alpha = \\frac{1}{V}\\left(\\frac{\\partial V}{\\partial T}\\right)_P$." },
  { id: 'f41', session: 1, front: "Qu'est-ce que le coefficient beta?", back: "Coefficient d'augmentation de pression isochore: $\\beta = \\frac{1}{P}\\left(\\frac{\\partial P}{\\partial T}\\right)_V$." },
  { id: 'f42', session: 1, front: "Qu'est-ce que le coefficient chi_T?", back: "Coefficient de compressibilite isotherme: $\\chi_T = -\\frac{1}{V}\\left(\\frac{\\partial V}{\\partial P}\\right)_T$." },
  ...
  { id: 'f49', session: 2, front: "Comment convertir Celsius en Kelvin?", back: "$T(\\text{K}) = T(\\text{°C}) + 273.15$" },
  { id: 'f50', session: 2, front: "Comment convertir Celsius en Fahrenheit?", back: "$T(\\text{°F}) = 1.8 \\times T(\\text{°C}) + 32$" },
  ...
  { id: 'f55', session: 2, front: "Quelle est l'equation d'etat du gaz parfait?", back: "$PV = nRT$, avec $R = 8.314 \\, \\text{J.K}^{-1}\\text{.mol}^{-1}$" },
  { id: 'f56', session: 2, front: "Quelles sont les conditions normales (STP)?", back: "$T = 273.15 \\, \\text{K}$ (0°C), $P = 1.013 \\times 10^5 \\, \\text{Pa}$ (1 atm), $V_m = 22.414 \\, \\text{L/mol}$" },
  { id: 'f57', session: 2, front: "Quelle est la loi de Mariotte?", back: "A T constante: $P_1 V_1 = P_2 V_2$" },
  { id: 'f58', session: 2, front: "Quelle est la loi de Charles?", back: "A V constant: $\\frac{P_1}{T_1} = \\frac{P_2}{T_2}$" },
  { id: 'f59', session: 2, front: "Quelle est la loi de Gay-Lussac?", back: "A P constante: $\\frac{V_1}{T_1} = \\frac{V_2}{T_2}$" },
  { id: 'f60', session: 2, front: "Quelle est l'energie cinetique moyenne d'une molecule?", back: "$\\frac{1}{2}m\\langle v^2 \\rangle = \\frac{3}{2}kT$, avec $k = 1.38 \\times 10^{-23} \\, \\text{J/K}$" },
  { id: 'f61', session: 2, front: "Qu'est-ce que le theoreme d'equipartition?", back: "Chaque degre de liberte contribue $\\frac{1}{2}kT$ a l'energie cinetique moyenne." },
  { id: 'f62', session: 2, front: "Quelle est l'energie d'un gaz monoatomique?", back: "$E_c = \\frac{3}{2}kT$ (3 degres de liberte)" },
  { id: 'f63', session: 2, front: "Quelle est l'energie d'un gaz diatomique?", back: "$E_c = \\frac{5}{2}kT$ (5 degres de liberte)" },
  { id: 'f64', session: 2, front: "Quelle est la relation entre alpha_V et alpha_l?", back: "Pour un corps isotrope: $\\alpha_V = 3 \\alpha_l$" },
  ...
  { id: 'f73', session: 3, front: "Qu'est-ce que la capacite thermique CV?", back: "Capacite thermique a volume constant. $\\delta Q_V = C_V \\, dT$." },
  { id: 'f74', session: 3, front: "Qu'est-ce que la capacite thermique CP?", back: "Capacite thermique a pression constante. $\\delta Q_P = C_P \\, dT$." },
  { id: 'f75', session: 3, front: "Quelle est la relation de Mayer?", back: "$C_P - C_V = nR$ (pour les gaz parfaits)" },
  { id: 'f76', session: 3, front: "Qu'est-ce que la chaleur latente?", back: "Quantite de chaleur necessaire pour faire passer l'unite de masse d'un corps d'un etat a un autre, a T constante. $Q = m \\, L$." },
  { id: 'f77', session: 3, front: "Quelle est la chaleur latente de fusion de la glace?", back: "$L = 334 \\, \\text{kJ/kg}$ a 0°C" },
  { id: 'f78', session: 3, front: "Quelle est la chaleur latente de vaporisation de l'eau?", back: "$L = 2260 \\, \\text{kJ/kg}$ a 100°C" },
  { id: 'f79', session: 3, front: "Qu'est-ce que la calorimetrie?", back: "Mesure des echanges de chaleur. Principe: $\\sum Q_i = 0$" },
  { id: 'f80', session: 3, front: "Quelle est l'expression du travail elementaire?", back: "$\\delta W = -P_{ext} \\, dV$" },
  { id: 'f81', session: 3, front: "Quel est le travail d'une transformation isobare?", back: "$W = -P(V_2 - V_1)$" },
  { id: 'f82', session: 3, front: "Quel est le travail d'une transformation isochore?", back: "$W = 0$ (pas de travail)" },
  { id: 'f83', session: 3, front: "Quel est le travail d'une transformation isotherme reversible?", back: "$W = nRT \\ln\\frac{V_2}{V_1}$" },
  ...
  { id: 'f88', session: 4, front: "Quelle est la forme differentielle du premier principe?", back: "$dU = \\delta Q + \\delta W$" },
  { id: 'f89', session: 4, front: "L'energie interne est-elle extensive ou intensive?", back: "Extensive. Elle a un caractere additif: $U_{total} = \\sum U_i$." },
  ...
  { id: 'f93', session: 4, front: "Quelle est l'energie interne d'un gaz monoatomique?", back: "$U = \\frac{3}{2}nRT$. $C_V = \\frac{3}{2}R$." },
  { id: 'f94', session: 4, front: "Quelle est l'energie interne d'un gaz diatomique?", back: "$U = \\frac{5}{2}nRT$. $C_V = \\frac{5}{2}R$." },
  { id: 'f95', session: 4, front: "Qu'est-ce que l'enthalpie H?", back: "$H = U + PV$. C'est une fonction d'etat." },
  { id: 'f96', session: 4, front: "Quelle est la variation d'enthalpie pour un gaz parfait?", back: "$dH = n C_P \\, dT$" },
  ...
  { id: 'f99', session: 4, front: "Que vaut Q pour une transformation isochore?", back: "$Q = \\Delta U = n C_V (T_2 - T_1)$" },
  { id: 'f100', session: 4, front: "Que vaut Q pour une transformation isobare?", back: "$Q = \\Delta H = n C_P (T_2 - T_1)$" },
  ...
  { id: 'f102', session: 4, front: "Que vaut Q pour une transformation isotherme reversible?", back: "$Q = -W = nRT \\ln\\frac{V_2}{V_1}$" },
  { id: 'f103', session: 4, front: "Quelle est l'equation d'une adiabatique reversible?", back: "$PV^{\\gamma} = \\text{cste}$, avec $\\gamma = C_P/C_V$" },
  { id: 'f104', session: 4, front: "Que vaut Q pour une transformation adiabatique?", back: "$Q = 0$ (pas d'echange de chaleur)." },
  { id: 'f105', session: 4, front: "Que vaut W pour une transformation adiabatique reversible?", back: "$W = n C_V (T_2 - T_1) = \\frac{P_2 V_2 - P_1 V_1}{\\gamma - 1}$" },
  ...
  { id: 'f107', session: 4, front: "Qu'est-ce qu'une transformation polytropique?", back: "Transformation reversible definie par $PV^k = \\text{cste}$, avec $k = \\frac{C_P - C_k}{C_V - C_k}$." },
  ...
  { id: 'f120', session: 5, front: "Quelle est la relation de Clausius pour un cycle reversible?", back: "$\\sum \\frac{Q_i}{T_i} = 0$" },
  { id: 'f121', session: 5, front: "Quelle est la relation de Clausius pour un cycle irreversible?", back: "$\\sum \\frac{Q_i}{T_i} < 0$" },
  { id: 'f122', session: 5, front: "Qu'est-ce que l'inegalite de Carnot-Clausius?", back: "$\\int \\frac{\\delta Q_{rev}}{T} \\geq \\int \\frac{\\delta Q_{irrev}}{T_{source}}$" },
  { id: 'f123', session: 5, front: "Qu'est-ce que l'entropie S?", back: "Fonction d'etat definie par $dS = \\frac{\\delta Q_{rev}}{T}$. Unite: J/K." },
  { id: 'f124', session: 5, front: "Quelle est la variation d'entropie pour une transformation reversible?", back: "$\\Delta S = \\int \\frac{\\delta Q_{rev}}{T}$" },
  { id: 'f125', session: 5, front: "Qu'est-ce que l'entropie echangee?", back: "$\\Delta S_e = \\frac{Q_{irrev}}{T_{source}}$. Entropie transferee avec l'exterieur." },
  ...
  { id: 'f127', session: 5, front: "Quel est le signe de l'entropie creee?", back: "Toujours positive ou nulle. $\\Delta S_c \\geq 0$." },
  ...
  { id: 'f134', session: 5, front: "Pour un systeme isole, que peut-on dire de l'entropie?", back: "$\\Delta S \\geq 0$. L'entropie d'un systeme isole ne peut qu'augmenter." },
  ...
  { id: 'f138', session: 6, front: "Que dit le premier principe pour un cycle?", back: "$W + Q_1 + Q_2 = 0$ (la somme des energies echangees est nulle)." },
  { id: 'f139', session: 6, front: "Qu'est-ce qu'un cycle moteur?", back: "Cycle qui convertit de la chaleur en travail. $W < 0$, $Q_1 > 0$, $Q_2 < 0$." },
  { id: 'f140', session: 6, front: "Qu'est-ce qu'un cycle recepteur?", back: "Cycle qui recoit du travail. $W > 0$, $Q_1 < 0$, $Q_2 > 0$." },
  { id: 'f141', session: 6, front: "Comment definit-on le rendement d'un moteur?", back: "$\\eta = \\frac{|W|}{Q_1} = \\frac{-W}{Q_1} = 1 + \\frac{Q_2}{Q_1}$" },
  { id: 'f142', session: 6, front: "Pourquoi le rendement est-il toujours < 1?", back: "Parce qu'une partie de la chaleur $Q_1$ est inevitablement rejetee a la source froide ($Q_2 < 0$)." },
  ...
  { id: 'f144', session: 6, front: "Comment definit-on l'efficacite d'une machine frigorifique?", back: "$e = \\frac{Q_2}{W} = \\frac{-Q_2}{Q_1 + Q_2}$" },
  ...
  { id: 'f146', session: 6, front: "Comment definit-on la performance d'une pompe a chaleur?", back: "$\\text{COP} = \\frac{-Q_1}{W} = \\frac{Q_1}{Q_1 + Q_2}$" },
  { id: 'f147', session: 6, front: "Pourquoi la performance d'une PAC est-elle > 1?", back: "Parce que $Q_1 > W$. On recupere plus de chaleur que le travail fourni." },
  ...
  { id: 'f149', session: 6, front: "Quelles sont les 4 etapes du cycle de Carnot?", back: "1. Detente isotherme a $T_1$\n2. Detente adiabatique\n3. Compression isotherme a $T_2$\n4. Compression adiabatique" },
  { id: 'f150', session: 6, front: "Quel est le rendement du cycle de Carnot?", back: "$\\eta_{Carnot} = 1 - \\frac{T_2}{T_1}$" },
  ...
  { id: 'f152', session: 6, front: "Quel est le rendement d'un cycle irreversible?", back: "$\\eta < \\eta_{Carnot}$ (toujours inferieur au rendement de Carnot)." },
  { id: 'f153', session: 6, front: "Quelle est l'efficacite d'une machine frigorifique de Carnot?", back: "$e = \\frac{T_2}{T_1 - T_2}$" },
  { id: 'f154', session: 6, front: "Quelle est la performance d'une pompe a chaleur de Carnot?", back: "$\\text{COP} = \\frac{T_1}{T_1 - T_2}$" },
  { id: 'f155', session: 6, front: "Pourquoi ne peut-on pas avoir un rendement de 100%?", back: "Il faudrait $T_2 = 0$ K (impossible) ou une source froide a 0 K (impossible)." },
  { id: 'f156', session: 6, front: "Qu'est-ce que le diagramme de Raveau?", back: "Diagramme montrant les differents types de machines thermiques selon les signes de $Q_1$, $Q_2$ et $W$." },
  { id: 'f157', session: 6, front: "Quelle est la relation entre T1, T2, Q1 et Q2 pour un cycle reversible?", back: "$\\frac{Q_1}{T_1} + \\frac{Q_2}{T_2} = 0$" },
...
export const formulasData = {
  general: [
    { name: "Equation d'etat du gaz parfait", formula: "PV = nRT", variables: "P (Pa), V (m³), n (mol), R = 8.314 J·K⁻¹·mol⁻¹, T (K)", session: 1 },
    { name: "Differentielle totale", formula: "df = \\frac{\\partial f}{\\partial x}dx + \\frac{\\partial f}{\\partial y}dy", variables: "Pour f(x, y) continue et derivable", session: 1 },
    { name: "Condition de Schwartz (DTE)", formula: "\\frac{\\partial^2 f}{\\partial x \\partial y} = \\frac{\\partial^2 f}{\\partial y \\partial x}", variables: "Egalite des derivees secondes croisees", session: 1 },
  ],
  temperature: [
    { name: "Conversion Kelvin-Celsius", formula: "T(\\text{K}) = T(\\text{°C}) + 273.15", variables: "", session: 2 },
    { name: "Conversion Celsius-Fahrenheit", formula: "T(\\text{°F}) = 1.8 \\times T(\\text{°C}) + 32", variables: "", session: 2 },
    { name: "Dilatation lineaire", formula: "L = L_0(1 + \\alpha_l \\Delta T)", variables: "\\alpha_l: coefficient de dilatation lineaire", session: 2 },
    { name: "Dilatation volumique", formula: "V = V_0(1 + \\alpha_V \\Delta T)", variables: "\\alpha_V = 3 \\alpha_l", session: 2 },
  ],
  travail: [
    { name: "Travail elementaire", formula: "\\delta W = -P_{ext} \\, dV", variables: "Travail des forces de pression", session: 3 },
    { name: "Travail isobare", formula: "W = -P(V_2 - V_1)", variables: "P = constante", session: 3 },
    { name: "Travail isochore", formula: "W = 0", variables: "V = constante", session: 3 },
    { name: "Travail isotherme reversible", formula: "W = nRT \\ln\\frac{V_2}{V_1}", variables: "Gaz parfait, T = constante", session: 3 },
  ],
  chaleur: [
    { name: "Chaleur a volume constant", formula: "Q_V = m \\, c_V (T_2 - T_1)", variables: "c_V: chaleur massique a V constant", session: 3 },
    { name: "Chaleur a pression constante", formula: "Q_P = m \\, c_P (T_2 - T_1)", variables: "c_P: chaleur massique a P constant", session: 3 },
    { name: "Relation de Mayer", formula: "C_P - C_V = nR", variables: "Gaz parfaits", session: 3 },
    { name: "Chaleur latente", formula: "Q = m \\, L", variables: "L: chaleur latente massique (J/kg)", session: 3 },
    { name: "Equation calorimetrique", formula: "\\sum_{i} Q_i = 0", variables: "Systeme isole", session: 3 },
  ],
  gazParfait: [
    { name: "Loi de Mariotte", formula: "P_1 V_1 = P_2 V_2", variables: "T = constante", session: 2 },
    { name: "Loi de Charles", formula: "\\frac{P_1}{T_1} = \\frac{P_2}{T_2}", variables: "V = constante", session: 2 },
    { name: "Loi de Gay-Lussac", formula: "\\frac{V_1}{T_1} = \\frac{V_2}{T_2}", variables: "P = constante", session: 2 },
    { name: "Energie cinetique moyenne", formula: "\\frac{1}{2}m\\langle v^2 \\rangle = \\frac{3}{2}kT", variables: "k = 1.38 × 10⁻²³ J/K", session: 2 },
    { name: "Theoreme d'equipartition", formula: "\\frac{E}{ddl} = \\frac{1}{2}kT", variables: "Energie par degre de liberte", session: 2 },
  ],
  premierPrincipe: [
    { name: "Premier principe", formula: "\\Delta U = W + Q", variables: "Variation d'energie interne", session: 4 },
    { name: "Forme differentielle", formula: "dU = \\delta Q + \\delta W", variables: "Transformation elementaire", session: 4 },
    { name: "Systeme isole", formula: "\\Delta U = 0", variables: "Pas d'echange d'energie", session: 4 },
    { name: "Energie interne gaz monoatomique", formula: "U = \\frac{3}{2}nRT", variables: "C_V = \\frac{3}{2}R", session: 4 },
    { name: "Energie interne gaz diatomique", formula: "U = \\frac{5}{2}nRT", variables: "C_V = \\frac{5}{2}R", session: 4 },
    { name: "Enthalpie", formula: "H = U + PV", variables: "Fonction d'etat", session: 4 },
    { name: "Variation d'enthalpie (GP)", formula: "dH = nC_P \\, dT", variables: "Pour un gaz parfait", session: 4 },
    { name: "Adiabatique reversible", formula: "PV^{\\gamma} = \\text{cste}", variables: "\\gamma = C_P/C_V", session: 4 },
    { name: "Adiabatique (T-V)", formula: "TV^{\\gamma-1} = \\text{cste}", variables: "Relation temperature-volume", session: 4 },
    { name: "Adiabatique (T-P)", formula: "T^{\\gamma} P^{1-\\gamma} = \\text{cste}", variables: "Relation temperature-pression", session: 4 },
    { name: "Travail adiabatique", formula: "W = nC_V(T_2 - T_1)", variables: "Q = 0", session: 4 },
    { name: "Travail adiabatique (P,V)", formula: "W = \\frac{P_2 V_2 - P_1 V_1}{\\gamma - 1}", variables: "Forme avec pression et volume", session: 4 },
    { name: "Polytropique", formula: "PV^k = \\text{cste}", variables: "k: indice polytropique", session: 4 },
    { name: "Polytropique - k isotherme", formula: "k = 1, \\quad C_k = \\infty", variables: "Transformation isotherme", session: 4 },
    { name: "Polytropique - k isobare", formula: "k = 0, \\quad C_k = C_P", variables: "Transformation isobare", session: 4 },
    { name: "Polytropique - k isochore", formula: "k = \\infty, \\quad C_k = C_V", variables: "Transformation isochore", session: 4 },
    { name: "Polytropique - k adiabatique", formula: "k = \\gamma, \\quad C_k = 0", variables: "Transformation adiabatique", session: 4 },
    { name: "Coeff gamma monoatomique", formula: "\\gamma = \\frac{5}{3} = 1.67", variables: "Gaz monoatomique (Ar, Ne)", session: 4 },
    { name: "Coeff gamma diatomique", formula: "\\gamma = \\frac{7}{5} = 1.4", variables: "Gaz diatomique (N₂, O₂, H₂)", session: 4 },
  ],
  secondPrincipe: [
    { name: "Relation de Clausius (rev)", formula: "\\sum_{i} \\frac{Q_i}{T_i} = 0", variables: "Cycle reversible", session: 5 },
    { name: "Relation de Clausius (irrev)", formula: "\\sum_{i} \\frac{Q_i}{T_i} < 0", variables: "Cycle irreversible", session: 5 },
    { name: "Entropie", formula: "dS = \\frac{\\delta Q_{rev}}{T}", variables: "Fonction d'etat, unite: J/K", session: 5 },
    { name: "Bilan entropique", formula: "\\Delta S = \\Delta S_e + \\Delta S_c", variables: "Variation = echangee + creee", session: 5 },
    { name: "Entropie echangee", formula: "\\Delta S_e = \\frac{Q}{T_{source}}", variables: "Echange avec l'exterieur", session: 5 },
    { name: "Entropie creee", formula: "\\Delta S_c \\geq 0", variables: "Toujours positive ou nulle", session: 5 },
    { name: "Systeme isole", formula: "\\Delta S \\geq 0", variables: "L'entropie augmente ou reste constante", session: 5 },
  ],
  machines: [
    { name: "Premier principe (cycle)", formula: "W + Q_1 + Q_2 = 0", variables: "Cycle ditherme", session: 6 },
    { name: "Rendement moteur", formula: "\\eta = 1 + \\frac{Q_2}{Q_1} = \\frac{-W}{Q_1}", variables: "Toujours < 1", session: 6 },
    { name: "Rendement de Carnot", formula: "\\eta_{Carnot} = 1 - \\frac{T_2}{T_1}", variables: "Rendement maximal", session: 6 },
    { name: "Efficacite machine frigorifique", formula: "e = \\frac{Q_2}{W}", variables: "Chaleur extraite / travail", session: 6 },
    { name: "Performance pompe a chaleur", formula: "\\text{COP} = \\frac{-Q_1}{W} = \\frac{Q_1}{Q_1 + Q_2}", variables: "Toujours > 1", session: 6 },
    { name: "Efficacite Carnot (frigo)", formula: "e_{Carnot} = \\frac{T_2}{T_1 - T_2}", variables: "Machine frigorifique reversible", session: 6 },
    { name: "Performance Carnot (PAC)", formula: "\\text{COP}_{Carnot} = \\frac{T_1}{T_1 - T_2}", variables: "Pompe a chaleur reversible", session: 6 },
    { name: "Relation Carnot reversible", formula: "\\frac{Q_1}{T_1} + \\frac{Q_2}{T_2} = 0", variables: "Cycle reversible", session: 6 },
  ],
  chaleursLatentes: [
    { name: "Fusion de la glace", formula: "L_{fusion} = 334 \\text{ kJ/kg}", variables: "A 0°C", session: 3 },
    { name: "Vaporisation de l'eau", formula: "L_{vap} = 2260 \\text{ kJ/kg}", variables: "A 100°C", session: 3 },
    { name: "Sublimation de la glace", formula: "L_{sub} = 2594 \\text{ kJ/kg}", variables: "A 0°C", session: 3 },
  ],
  constantes: [
    { name: "Constante des gaz parfaits", formula: "R = 8.314 \\text{ J·K}^{-1}\\text{·mol}^{-1}", variables: "", session: 2 },
    { name: "Constante de Boltzmann", formula: "k = 1.38 \\times 10^{-23} \\text{ J/K}", variables: "", session: 2 },
    { name: "Point triple de l'eau", formula: "T = 273.16 \\text{ K}, \\quad P = 611 \\text{ Pa}", variables: "", session: 2 },
    { name: "Volume molaire STP", formula: "V_m = 22.414 \\text{ L/mol}", variables: "T = 273.15 K, P = 1 atm", session: 2 },
    { name: "Zero absolu", formula: "T = 0 \\text{ K} = -273.15 \\text{ °C}", variables: "", session: 2 },
  ]
};
